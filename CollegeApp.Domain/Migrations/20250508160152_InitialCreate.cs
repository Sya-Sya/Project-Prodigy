        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublisherCommonModelId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Mobile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_Publishers_PublisherCommonModelId",
                        column: x => x.PublisherCommonModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_PublisherCommonModelId",
                table: "Books",
                column: "PublisherCommonModelId");
        }
